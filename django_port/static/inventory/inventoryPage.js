...
import { byId, escapeHtml, formatDateTime, mountScannerWorkflow, normalizeRawScan, setBadgeState, } from "./shared.js";
...
document.addEventListener("DOMContentLoaded", () => {
    const pageConfig = byId("inventory-page-config");
    ...
    const telemetrySessionId = byId("telemetry_session_id");
    const telemetrySessionWindow = byId("telemetry_session_window");
    const telemetryReaderStatus = byId("telemetry_reader_status");
    const telemetryReaderSource = byId("telemetry_reader_source");
    const telemetryBridgeLocalStatus = byId("telemetry_bridge_local_status");
    const telemetryActiveStudent = byId("telemetry_active_student");
    const telemetryRecentEvents = byId("telemetry_recent_events");
    const telemetryServerTime = byId("telemetry_server_time");
